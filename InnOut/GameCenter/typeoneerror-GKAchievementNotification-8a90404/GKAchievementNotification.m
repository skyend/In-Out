...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame]))
    {
        ...
        //UIImage *backgroundStretch = [[UIImage imageNamed:@"gk-notification.png"] stretchableImageWithLeftCapWidth:16.0f topCapHeight:0.0f];
        UIImage * backgroundStretch = [UIImage imageNamed:@"gk-notification.png"];
        UIImageView *tBackground = [[UIImageView alloc] initWithImage:backgroundStretch];
        ...
        tTextLabel.textColor = [UIColor blackColor];
        ...
        tDetailLabel.textColor = [UIColor blackColor];
